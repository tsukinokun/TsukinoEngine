...
namespace Tsukino::BuiltIn {
    ...
    void BuiltInShaders::Initialize(Tsukino::Asset::AssetManager* assetManager) {
        ...
        debugVS        = assetManager->Load(Tsukino::Core::Path("Tsukino.BuiltIn/Assets/Shaders/DebugLine.vs.hlsl"));
        debugPS        = assetManager->Load(Tsukino::Core::Path("Tsukino.BuiltIn/Assets/Shaders/DebugLine.ps.hlsl"));
        ...
        waterPS        = assetManager->Load(Tsukino::Core::Path("Tsukino.BuiltIn/Assets/Shaders/Water.ps.hlsl"));
    }
}    // namespace Tsukino::BuiltIn
